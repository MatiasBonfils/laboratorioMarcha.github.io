   ...
   rectangulo_arotd.style.display = "none";
    ...
    //Angulo cadera
      //IZQ
        ...
        document.getElementById("ang_cad_iz").innerHTML = angulo_cadera_i+ " °" ;
      //DER
    ...
    angulo_rodilla_de = angulo_rodilla_de.toFixed(0);
...
new controls
    ...
    .add([
      ...
      new controls.Toggle(
          {title: 'Linea de mandibula', field: 'lineaMandibula'}),
      new controls.Toggle(
          {title: 'Linea de hombro', field: 'lineaHombro'}),
      new controls.Toggle(
          {title: 'Linea de Cadera', field: 'lineaCadera'}),
      new controls.Toggle(
          {title: 'Rotacion Interna/Externa', field: 'rotIntExt'}),
      new controls.Toggle(
          {title: 'Mostrar Ángulos Izquierdos de la Marcha', field: 'angulosIzquierdos'}),
      new controls.Toggle(
          {title: 'Mostrar Ángulos Derechos de la Marcha', field: 'angulosDerechos'}),
      new controls.Toggle(
          {title: 'Linea de valgo/varo', field: 'valgo_varo'}),
      new controls.Slider({
